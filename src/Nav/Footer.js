  ...
  return (
    <section className='mainfooter' >
        <div className='container-fluid mt-5 footer'>
            <div className='row gy-4 pt-5 foot-main'>
                ...
                <div className='last-footer py-3 text-center '>
                    <p className='fw-bold text-white my-3 my-auto'>© 2024 Sports Shop. All Rights Reserved.</p>
                </div>
            </div>
